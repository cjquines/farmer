...
export const Entities = {
  ...
  Bush: "Entities.Bush",
  /**
   * Cacti come in 10 different sizes (0-9). When harvested, adjacent cacti that
   * are in sorted order will also be harvested recursively.
  ...
  /**
   * One in five pumpkins dies when it grows up, leaving behind a dead pumpkin.
   * Dead pumpkins are useless and disappear when something new is planted.
   * `can_harvest()` always returns `False` on dead pumpkins.
   */
  DeadPumpkin: "Entities.Dead_Pumpkin",
  /**
   * A piece of the tail of the dinosaur hat. When wearing the dinosaur hat,
   * the tail is dragged behind the drone filling previously moved tiles.
   *
   ...
   * When you harvest a pumpkin you get `Items.Pumpkin` equal to the number of
   * pumpkins in the mega pumpkin cubed.
   *
   ...
   * `Items.Power`.
   *
   * If you harvest a sunflower with the maximum number of petals (and there
   * are at least 10 sunflowers) you get 5x bonus power.
   *
  ...
  /**
   * A treasure that contains gold equal to the side length of the maze in
   * which it is hidden. It can be harvested like a plant.
   */
  Treasure: "Entities.Treasure",
  /**
   * Trees drop more wood than bushes. They take longer to grow if other trees
   * grow next to them.
   *
